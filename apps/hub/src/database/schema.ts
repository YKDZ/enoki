...
export const metricSamples = sqliteTable(
  "metric_samples",
  {
    ...
    cpuUserPercent: real("cpu_user_percent"),
    cpuSystemPercent: real("cpu_system_percent"),
    cpuIowaitPercent: real("cpu_iowait_percent"),
    cpuStealPercent: real("cpu_steal_percent"),
    cpuIdlePercent: real("cpu_idle_percent"),
    memoryUsedBytes: integer("memory_used_bytes"),
    memoryTotalBytes: integer("memory_total_bytes"),
    memoryCacheBytes: integer("memory_cache_bytes"),
...
export const metricDisks = sqliteTable("metric_disks", {
  ...
  readBytesDelta: integer("read_bytes_delta").notNull().default(0),
  writeBytesDelta: integer("write_bytes_delta").notNull().default(0),
  ioUtilizationPercent: real("io_utilization_percent"),
  readAwaitMs: real("read_await_ms"),
  writeAwaitMs: real("write_await_ms"),
  weightedIoPercent: real("weighted_io_percent"),
});
